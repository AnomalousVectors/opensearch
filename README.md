...
This repo provides custom OpenSearch and Dashboards instances to support agentic penetration testing 
...
Before using Discover, you just need to map the index names to Index Patterns within Dashboards. You can do this in the [web UI](https://opensearch-dashboards.url:5601/app/management/opensearch-dashboards/indexPatterns) using [this guidance](https://docs.opensearch.org/latest/dashboards/management/index-patterns/), but it's easier via the API. Note, If you create the Index Patterns before the indexes are created in OpenSearch, you will see an error when attempting to view the index data within the Dashboards' Discover application. Thus, it may be best to populate the indexes before creating these Index Patterns. Use the following to create five Index Patterns that align with Burp Exporter's default index names:

```shell
curl -sk -u admin:admin -X POST "https://opensearch-dashboards.url:5601/api/saved_objects/index-pattern/tool-burp-exporter?overwrite=true" -H "osd-xsrf: true" -H "Content-Type: application/json" -d "{\"attributes\":{\"title\":\"tool-burp-exporter\",\"timeFieldName\":\"meta.indexed_at\",\"fields\":\"[{\\\"name\\\":\\\"meta.indexed_at\\\",\\\"type\\\":\\\"date\\\",\\\"esTypes\\\":[\\\"date\\\"],\\\"searchable\\\":true,\\\"aggregatable\\\":true,\\\"readFromDocValues\\\":true}]\"}}"

curl -sk -u admin:admin -X POST "https://opensearch-dashboards.url:5601/api/saved_objects/index-pattern/tool-burp-findings?overwrite=true" -H "osd-xsrf: true" -H "Content-Type: application/json" -d "{\"attributes\":{\"title\":\"tool-burp-findings\",\"timeFieldName\":\"meta.indexed_at\",\"fields\":\"[{\\\"name\\\":\\\"meta.indexed_at\\\",\\\"type\\\":\\\"date\\\",\\\"esTypes\\\":[\\\"date\\\"],\\\"searchable\\\":true,\\\"aggregatable\\\":true,\\\"readFromDocValues\\\":true}]\"}}"

curl -sk -u admin:admin -X POST "https://opensearch-dashboards.url:5601/api/saved_objects/index-pattern/tool-burp-settings?overwrite=true" -H "osd-xsrf: true" -H "Content-Type: application/json" -d "{\"attributes\":{\"title\":\"tool-burp-settings\",\"timeFieldName\":\"meta.indexed_at\",\"fields\":\"[{\\\"name\\\":\\\"meta.indexed_at\\\",\\\"type\\\":\\\"date\\\",\\\"esTypes\\\":[\\\"date\\\"],\\\"searchable\\\":true,\\\"aggregatable\\\":true,\\\"readFromDocValues\\\":true}]\"}}"

curl -sk -u admin:admin -X POST "https://opensearch-dashboards.url:5601/api/saved_objects/index-pattern/tool-burp-sitemap?overwrite=true" -H "osd-xsrf: true" -H "Content-Type: application/json" -d "{\"attributes\":{\"title\":\"tool-burp-sitemap\",\"timeFieldName\":\"meta.indexed_at\",\"fields\":\"[{\\\"name\\\":\\\"meta.indexed_at\\\",\\\"type\\\":\\\"date\\\",\\\"esTypes\\\":[\\\"date\\\"],\\\"searchable\\\":true,\\\"aggregatable\\\":true,\\\"readFromDocValues\\\":true}]\"}}"

curl -sk -u admin:admin -X POST "https://opensearch-dashboards.url:5601/api/saved_objects/index-pattern/tool-burp-traffic?overwrite=true" -H "osd-xsrf: true" -H "Content-Type: application/json" -d "{\"attributes\":{\"title\":\"tool-burp-traffic\",\"timeFieldName\":\"meta.indexed_at\",\"fields\":\"[{\\\"name\\\":\\\"meta.indexed_at\\\",\\\"type\\\":\\\"date\\\",\\\"esTypes\\\":[\\\"date\\\"],\\\"searchable\\\":true,\\\"aggregatable\\\":true,\\\"readFromDocValues\\\":true}]\"}}"
